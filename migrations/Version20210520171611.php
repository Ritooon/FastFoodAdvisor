 ...
 */
final class Version20210520171611 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notes_restaurants (notes_id INT NOT NULL, restaurants_id INT NOT NULL, INDEX IDX_470EF9ECFC56F556 (notes_id), INDEX IDX_470EF9EC4DCA160A (restaurants_id), PRIMARY KEY(notes_id, restaurants_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE notes_users (notes_id INT NOT NULL, users_id INT NOT NULL, INDEX IDX_8E744D49FC56F556 (notes_id), INDEX IDX_8E744D4967B3B43D (users_id), PRIMARY KEY(notes_id, users_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
